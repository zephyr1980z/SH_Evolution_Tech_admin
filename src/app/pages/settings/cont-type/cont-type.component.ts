...
import { AddOrEditContTypeModelComponent } from './add-or-edit-cont-type-model/add-or-edit-cont-type-model.component'
import { CoreService } from '../../../services/core.service'
import { User } from '../../../models/user.model'
import { AuthenticationService } from '../../../services/authentication.service'
import { ContTypeDetailComponent } from './cont-type-detail/cont-type-detail.component'

@Component({
  selector: 'app-cont-type',
  templateUrl: './cont-type.component.html',
})
export class ContTypeComponent implements OnInit {
  ...
  async searchData(reset: boolean = false) {
    ...
    this.apiService.post(this.apiService.CONT_TYPE.PAGINATION, dataSearch).then((data) => {
      if (data) {
        this.loading = false
        this.total = data[1]
  ...
  clickAdd() {
    this.dialog
      .open(AddOrEditContTypeModelComponent, { disableClose: false })
      .afterClosed()
      .subscribe((data) => {
        this.searchData()
      })
  ...
  clickEdit(object: any) {
    this.dialog
      .open(AddOrEditContTypeModelComponent, { disableClose: false, data: object })
      .afterClosed()
      .subscribe((data) => {
        this.searchData()
      })
  ...
  clickDetail(data: any) {
    this.dialog
      .open(ContTypeDetailComponent, { disableClose: false, data })
      .afterClosed()
      .subscribe((res) => {})
  }
  ...
  setActiveItem(data: any) {
    ...
    this.apiService.post(this.apiService.CONT_TYPE.DELETE, { id: data.id }).then((res) => {
