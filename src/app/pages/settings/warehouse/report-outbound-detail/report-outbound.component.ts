...
@Component({
  selector: 'app-report-outbound',
  templateUrl: './report-outbound.component.html',
})
export class ReportOutboundComponent implements OnInit {
  ...
  lstStatus = this.coreService.convertObjToArray(enumData.OutBoundStatus)
  listFilter: any = []
  dataQuarterly: any = []
  dataObject: any
  enumRole = enumData.Role.Setting_Outbound_Report
  ...
  async searchData(reset: boolean = false) {
    ...
    this.apiService.post(this.apiService.OUTBOUND.FIND_OUTBOUND_FOR_REPORT, dataSearch).then((data: any) => {
      if (data) {
  ...
  async onDownloadExcel() {
    ...
    const fileName = 'Bao_Cao_Xuat_Kho' + date + '.xlsx'
    let dataExcel: any = []
