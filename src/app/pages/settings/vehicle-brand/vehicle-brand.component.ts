...
import { AddOrEditVehicleBrandComponent } from './add-or-edit-vehicle-brand/add-or-edit-vehicle-brand.component'
...
export class VehicleBrandComponent implements OnInit {
  ...
  enumRole = enumData.Role.Setting_Vehicle_Brand
  ...
  async searchData(reset: boolean = false) {
    ...
    this.apiService.post(this.apiService.VEHICLE_BRAND.PAGINATION, dataSearch).then((data: any) => {
  ...
  clickAdd() {
    this.dialog
      .open(AddOrEditVehicleBrandComponent, { disableClose: false })
      .afterClosed()
      .subscribe((flag: any) => {
  ...
  clickEdit(data: any) {
    this.dialog
      .open(AddOrEditVehicleBrandComponent, { disableClose: false, data: data })
      .afterClosed()
      .subscribe((flag: any) => {
        if (flag) this.searchData()
      })
  ...
  setActiveItem(data: any) {
    this.notifyService.showloading()
    this.apiService.post(this.apiService.VEHICLE_BRAND.DELETE, { id: data.id }).then((res: any) => {
